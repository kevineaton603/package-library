...
export type Action<TAppState extends object, TPayload extends any = undefined> = (args?: TPayload)  => SetAction<TAppState>;
...
export type EntitySliceActions<TAppState extends object, TEntity extends object> = SliceActions<TAppState> & {
    ...
    removeOne: Action<TAppState, TEntity>;
    removeMany: Action<TAppState, TEntity[]>;
